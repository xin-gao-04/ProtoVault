...
- 源代码管理视图包含：暂存的更改、未暂存的更改、提交信息框、“提交暂存更改”按钮、刷新、全部暂存、全部取消暂存、分支切换、新建并切换分支。
...
- 如果用户问“提交版本在哪里”，必须说明：左侧工作栏点击“源代码管理”，在中间 Git 视图中暂存文件、填写提交信息，然后点击“提交暂存更改”。
